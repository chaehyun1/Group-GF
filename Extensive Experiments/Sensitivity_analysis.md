...
- Effect of polynomial graph filters: The best performance in NDCG@10 is achieved by using second-order $f_1(\bar{P}_u)$, third-order $f_2(\bar{P}_g)$, and third-order $f_3(\bar{P}_{\text{uni}})$ filters, capturing nuanced interaction patterns for optimal accuracy.
